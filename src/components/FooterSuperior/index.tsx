...
type Props = {
  footerAjuste: boolean
}

const FooterSuperior = ({ footerAjuste }: Props) => (
  <>
    {footerAjuste ? (
      <ContainerFooter>
            ...
            <div>
              ...
              <ContainerBio>
                <p>
                  ...
                  oferecendo soluções tecnológicas inovadoras para o mercado.
                  Com uma ampla gama de produtos, incluindo computadores,
                  notebooks, monitores, PC´s all in one, PC´s Nuke e muito mais,
                  a Strong Tech é reconhecida por sua qualidade e desempenho
                  superior.
                </p>
              </ContainerBio>
            </div>
