    ...
    <RedesSociais>
      <div className="container">
        ...
        <div>
          <h4>Nós siga</h4>
          <ul>
            <RedesFooter src={facebook} alt="Facebook" />
            <RedesFooter src={instagram} alt="Instagram" />
            <RedesFooter src={whatsapp} alt="Whatsapp" />
          </ul>
        </div>
      </div>
    </RedesSociais>
    <div className="container">
      ...
      <aside>
        <p>
          ...
          oferecendo soluções tecnológicas inovadoras para o mercado. Com uma
          ampla gama de produtos, incluindo computadores, notebooks, monitores,
          PC´s all in one, PC´s Nuke e muito mais, a Strong Tech é reconhecida
          por sua qualidade e desempenho superior.
        </p>
      </aside>
    </div>
  </ContainerFooter>
