      ...
      <Container>
        ...
        <main>
          ...
          <Paragrafo corParagrafo>
            ...
            processadores de alta performance, memória RAM de última geração e
            uma grande variedade de configurações, nossos Desktops são a escolha
            certa para quem busca uma solução completa.
          </Paragrafo>
          <ul>
            <li>
